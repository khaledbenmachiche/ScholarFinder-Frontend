...
const DetailArticle = () => {
    ...
    return (
        ...
        <div className="w-screen h-screen ">
            <NavBarUtilisateur/>
            <h1 className="font-poppins font-bold text-blue-600 ml-28 lg:mt-12 lg:ml-[420px] text-sm  lg:text-2xl  "> L'infini
                du savoir vous attend à portée de clic.</h1>
            ...
            <div className="flex justify-center gap-5 pr-6 mt-4 lg:justify-end">
                <button onClick={openPdf} className="flex items-center p-2 bg-gray-300 whitespace-nowrap"><FaRegFilePdf size={20}/> Ouvrir sous forme pdf</button>
                <button className="flex items-center p-2 bg-gray-300 whitespace-nowrap"><MdFavoriteBorder size={20}/> AJOUTER AUX FAVORIS</button>
            </div>
