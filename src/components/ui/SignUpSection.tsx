...
const SignUpSection: React.FC = () => {
    ...
    return (
        <div
            className="relative w-full md:w-screen lg:w-[900px] md:h-screen h-fit lg:h-screen pt-4 pb-2 px-8 bg-white flex flex-col">
            ...
            <form className="flex flex-col w-full h-[800px] md:px-8 items-center justify-center gap-2.5"
                ...
                <div className="flex w-full gap-2">
                    ...
                    <div className="flex flex-col justify-center w-full">
                        <label className="block ml-2 font-light text-md ">Confirm Password</label>
                        <div className="relative">
                            <input className="mt-1 border rounded-[10px] border-blue-700 w-full p-2 bg-[#EEF5FC] "
            ...
            <div className="flex justify-center w-full gap-2 mt-auto whitespace-nowrap">
                ...
                <span onClick={() => navigate("/signin")} className="text-sm font-medium text-blue-700 cursor-pointer">Connectez-vous maintenant?</span>
            </div>
        </div>
